	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float4 fetchOpaqueVal23 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ( (ase_screenPosNorm).xy + ( ( ( (appendResult97).xy + -0.5 ) * 2.0 ) * ( _NormalIntensity * ( op62 * IN.ase_color.a ) ) ) ) ), 1.0 );
...
ASEEND*/
//CHKSM=AC0184B989998D4EC73978A578A0F76ACB8EE687