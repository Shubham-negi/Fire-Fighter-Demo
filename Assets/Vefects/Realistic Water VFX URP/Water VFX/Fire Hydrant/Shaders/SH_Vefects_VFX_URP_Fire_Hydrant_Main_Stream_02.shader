	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord195 = v.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float streamStrength125 = ( _StreamStrength * v.texcoord.w );
				...
				float2 texCoord205 = v.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float3 WPO200 = ( ( ( ( tex2Dlod( _WPOTexture, float4( panner197, 0, 0.0) ).g + -0.5 ) * 2.0 ) * ( v.normalOS * _WPOStrength ) ) * ( saturate( texCoord205.y ) + 0.25 ) );
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 texCoord84 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord56 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_58_0 = saturate( texCoord56.y );
				float streamStrength125 = ( _StreamStrength * IN.ase_texcoord8.w );
				...
				float2 texCoord149 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float4 fetchOpaqueVal23 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ( (ase_screenPosNorm).xy + ( ( ( (temp_output_163_0).xy + -0.5 ) * 2.0 ) * ( ( _NormalIntensity * streamStrength125 ) * ( op62 * IN.ase_color.a ) ) ) ) ), 1.0 );
				float4 lerpResult24 = lerp( fetchOpaqueVal23 , float4( _Color01 , 0.0 ) , _ColorStrength);
				
				float2 texCoord175 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float Occlusion = 1;
				float Alpha = ( op62 * IN.ase_color.a );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord195 = v.ase_texcoord * float2( 1,1 ) + float2( 0,0 );
				float streamStrength125 = ( _StreamStrength * v.ase_texcoord.w );
				float lerpResult222 = lerp( 0.1 , 1.0 , streamStrength125);
				float2 appendResult218 = (float2(texCoord195.x , ( texCoord195.y * lerpResult222 )));
				float2 panner197 = ( 1.0 * _Time.y * _WPOPanSpeed + ( appendResult218 * _WPOUVScale ));
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float2 appendResult5_g11 = (float2(0.0 , 0.0));
				float2 panner70 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord55 * appendResult4_g11 ) + appendResult5_g11 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float2 texCoord56 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_58_0 = saturate( texCoord56.y );
				float streamStrength125 = ( _StreamStrength * IN.ase_texcoord3.w );
				float temp_output_59_0 = saturate( ( saturate( ( ( tex2D( _FireSprinklerTexture, panner70 ).r - temp_output_58_0 ) - ( 1.0 - streamStrength125 ) ) ) * _ThickPartsOpacity ) );
				float2 appendResult4_g10 = (float2(_TilingXDroplets , _TilingYDroplets));
				float2 appendResult5_g10 = (float2(0.0 , 0.0));
				float2 panner71 = ( 1.0 * _Time.y * _PanSpeedDroplets + ( float3( ( ( texCoord55 * appendResult4_g10 ) + appendResult5_g10 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord195 = v.texcoord0.xy * float2( 1,1 ) + float2( 0,0 );
				float streamStrength125 = ( _StreamStrength * v.texcoord0.w );
				float lerpResult222 = lerp( 0.1 , 1.0 , streamStrength125);
				float2 appendResult218 = (float2(texCoord195.x , ( texCoord195.y * lerpResult222 )));
				float2 panner197 = ( 1.0 * _Time.y * _WPOPanSpeed + ( appendResult218 * _WPOUVScale ));
				float2 texCoord205 = v.texcoord0.xy * float2( 1,1 ) + float2( 0,0 );
				float3 WPO200 = ( ( ( ( tex2Dlod( _WPOTexture, float4( panner197, 0, 0.0) ).g + -0.5 ) * 2.0 ) * ( v.normalOS * _WPOStrength ) ) * ( saturate( texCoord205.y ) + 0.25 ) );
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 texCoord84 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g12 = (float2(_TilingX , _TilingY));
				float2 appendResult5_g12 = (float2(0.0 , 0.0));
				float2 panner91 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord84 * appendResult4_g12 ) + appendResult5_g12 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float4 tex2DNode94 = tex2D( _FireSprinklerTextureNormal, panner91 );
				float2 texCoord55 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g11 = (float2(_TilingX , _TilingY));
				float2 appendResult5_g11 = (float2(0.0 , 0.0));
				float2 panner70 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord55 * appendResult4_g11 ) + appendResult5_g11 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float2 texCoord56 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_58_0 = saturate( texCoord56.y );
				float streamStrength125 = ( _StreamStrength * IN.ase_texcoord5.w );
				float temp_output_59_0 = saturate( ( saturate( ( ( tex2D( _FireSprinklerTexture, panner70 ).r - temp_output_58_0 ) - ( 1.0 - streamStrength125 ) ) ) * _ThickPartsOpacity ) );
				float3 appendResult156 = (float3(( tex2DNode94.r * temp_output_59_0 ) , ( tex2DNode94.g * temp_output_59_0 ) , tex2DNode94.b));
				float2 appendResult4_g13 = (float2(_TilingXDroplets , _TilingYDroplets));
				float2 appendResult5_g13 = (float2(0.0 , 0.0));
				...
				float3 temp_output_163_0 = ( ( appendResult156 * 0.5 ) + ( appendResult160 * 0.5 ) );
				float temp_output_147_0 = saturate( max( temp_output_59_0 , temp_output_146_0 ) );
				float2 texCoord149 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float screenDepth36 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth36 = saturate( ( screenDepth36 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace )
			{
				...
				float3 norm100 = temp_output_163_0;
				float temp_output_147_0 = saturate( max( temp_output_59_0 , temp_output_146_0 ) );
				float2 texCoord175 = IN.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth178 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth178 = saturate( ( screenDepth178 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace) : SV_TARGET
			{
				...
				float2 texCoord55 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult4_g11 = (float2(_TilingX , _TilingY));
				float2 appendResult5_g11 = (float2(0.0 , 0.0));
				float2 panner70 = ( 1.0 * _Time.y * _PanSpeed + ( float3( ( ( texCoord55 * appendResult4_g11 ) + appendResult5_g11 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float2 texCoord56 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_58_0 = saturate( texCoord56.y );
				float streamStrength125 = ( _StreamStrength * IN.ase_texcoord.w );
				float temp_output_59_0 = saturate( ( saturate( ( ( tex2D( _FireSprinklerTexture, panner70 ).r - temp_output_58_0 ) - ( 1.0 - streamStrength125 ) ) ) * _ThickPartsOpacity ) );
				float2 appendResult4_g10 = (float2(_TilingXDroplets , _TilingYDroplets));
				float2 appendResult5_g10 = (float2(0.0 , 0.0));
				float2 panner71 = ( 1.0 * _Time.y * _PanSpeedDroplets + ( float3( ( ( texCoord55 * appendResult4_g10 ) + appendResult5_g10 ) ,  0.0 ) + float3( 0,0,0 ) ).xy);
				float temp_output_146_0 = saturate( ( saturate( ( saturate( tex2D( _FireSprinklerTexture, panner71 ).g ) * streamStrength125 ) ) * _DropsOpacity ) );
				float temp_output_147_0 = saturate( max( temp_output_59_0 , temp_output_146_0 ) );
				float2 texCoord149 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				...
				surfaceDescription.Alpha = ( op62 * IN.ase_color.a );
...
ASEEND*/
//CHKSM=75BA5608C11C8BBFE9B6213B697609BA88A9C479